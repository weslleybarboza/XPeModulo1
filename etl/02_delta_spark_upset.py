...
enemnovo = (
    ...
    .load("s3//datalake-weslley-production-156814630337-tf/staging-zone/enem")
)
...
enemvelho = DeltaTable.forPath(spark, "s3//datalake-weslley-production-156814630337-tf/staging-zone/enem")
