...
@dag(default_args=default_args, schedule_interval=None, catchup=False, tags=["emr", "aws", "enem", "weslley"], description="Pipeline para processamento de dados do ENEM 2020")
def pipeline_enem():
    """
    ...
    def emr_process_enem_data():
        cluster_id = client.run_job_flow(
            ...
            LogUri='s3://datalake-weslley-production-156814630337-tf/emr-logs',
